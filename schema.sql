CREATE DATABASE  IF NOT EXISTS `bd_gestao_ferramentas` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bd_gestao_ferramentas`;
-- MySQL dump 10.13  Distrib 8.0.43, for Win64 (x86_64)
--
-- Host: localhost    Database: bd_gestao_ferramentas
-- ------------------------------------------------------
...
CREATE TABLE `tb_galpao` (
  `id_galpao` bigint NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) NOT NULL,
...
CREATE TABLE `tb_ordem_servico` (
  ...
  `id_ferramenta` bigint DEFAULT NULL,
...
-- Dump completed on 2026-06-18 17:20:56
